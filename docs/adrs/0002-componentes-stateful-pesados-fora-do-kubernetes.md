# ADR 0002: Componentes stateful pesados fora do Kubernetes
...
Operar **PostgreSQL, Kafka e MinIO fora do Kubernetes**, rodando diretamente no host Linux dos servidores físicos dedicados.
...
- ⚠️ **Auto-healing:** Perde-se o reinício automático do K8s, que deve ser substituído por mecanismos nativos (Patroni para PG, KRaft para Kafka, e systemd como monitor de processo).
